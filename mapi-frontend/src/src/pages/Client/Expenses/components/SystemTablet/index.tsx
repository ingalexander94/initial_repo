        ...
        <div className={styles.table_item}>
            {
              listOperationExpenses.map((operation: any, i: any) => (
                <ul key={i}>
                  <li>
                    <strong>{operation.ope_departure_location}</strong>
                  </li>

                  <li>
                    <strong>{operation.ope_arriaval_place}</strong>
                  </li>
                  <li>
                    <strong>{operation.ope_km_driven}</strong>
                  </li>
                  <li>
                    <strong>{operation.personal_names} {operation.personal_surnames}</strong>
                  </li>
                  <li>
                    <strong>{operation.ope_company} </strong>
                  </li>
                  <li>
